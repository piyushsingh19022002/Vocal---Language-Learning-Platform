            ...
            {courses.map((course) => (
              ...
              >
                <div className="course-card-header">
                  <div className="course-flag">{course.image || course.language}</div>
                  ...
                  <div className="course-lessons-preview">
                    ...
                    <div className="lessons-preview-list">
                      {course.lessons.slice(0, 5).map((lesson, index) => (
                        <div key={lesson._id || index} className="lesson-preview-item">
                          <span className="lesson-preview-number">{index + 1}</span>
                          <span className="lesson-preview-title">{lesson.title || 'Lesson ' + (index + 1)}</span>
                        </div>
                      ))}
                      {course.lessons.length > 5 && (
                        <div className="lesson-preview-more">
